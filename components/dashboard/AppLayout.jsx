      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 md:p-10 space-y-12">
        ...
        <div className="space-y-6 max-w-3xl">
          ...
          <p className="text-slate-500">
            Scroll down to view materials and trigger the scroll-to-top button.
          </p>
          <div className="h-96 bg-slate-100 dark:bg-slate-900/40 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 flex items-center justify-center">
            Section 1
          </div>
          <div className="h-96 bg-slate-100 dark:bg-slate-900/40 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 flex items-center justify-center">
            Section 2
