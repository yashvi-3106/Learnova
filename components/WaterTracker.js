    ...
    <section className="rounded-[2rem] border border-white/10 bg-white/85 dark:bg-slate-950/80 dark:border-slate-700 shadow-2xl shadow-slate-950/20 backdrop-blur-xl p-6 lg:p-8">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-semibold text-slate-950 dark:text-slate-50">Water Intake</h2>
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-300">
            Track your hydration with a clear daily goal and simple water tracking controls.
          </p>
        </div>
        <div className="rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-slate-50/90 dark:bg-slate-900/80 p-4 text-center shadow-sm">
          ...
          <p className="mt-2 text-xs uppercase tracking-[0.35em] text-slate-500 dark:text-slate-400">Daily goal</p>
        </div>
      </div>
      ...
      <div className="mt-8 rounded-3xl border border-slate-200/80 dark:border-slate-800/80 bg-slate-50/90 dark:bg-slate-900/80 p-6 shadow-sm">
        <div className="flex items-center justify-between gap-6">
          <div>
            <p className="text-sm uppercase tracking-[0.35em] text-slate-500 dark:text-slate-400">Water glasses</p>
            <p className="mt-2 text-4xl font-semibold text-slate-950 dark:text-slate-100">{glasses}</p>
            <p className="text-sm text-slate-600 dark:text-slate-400">Target: {goal} glasses</p>
          </div>
            ...
            <span className="text-sm font-semibold">{Math.round(progress)}% hydrated</span>
          </div>
        </div>

        <div className="mt-6 h-4 overflow-hidden rounded-full bg-slate-200 dark:bg-slate-800">
          <div className="h-full rounded-full bg-gradient-to-r from-purple-500 via-violet-600 to-fuchsia-500 transition-all" style={{ width: `${progress}%` }} />
        </div>
