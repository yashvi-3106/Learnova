...
const COMMANDS = [
  ...
  },
  {
    ...
    description: "Open institute dashboard",
  ...
  },
  {
    ...
    description: "View academic activities",
    href: "/activity",
    category: "Features",
  },
  {
    id: "notices",
    label: "Notice Board",
    description: "View institution notices",
    href: "/notices",
    category: "Features",
  },
  {
  ...
  },
  {
    id: "contact",
    label: "Contact",
    description: "Get in touch with Learnova",
    href: "/contact",
    category: "Support",
  },
  {
...
const CommandPalette = ({ isOpen, onClose }) => {
  ...
  const filtered = query.trim()
    ? COMMANDS.filter((c) =>
        fuzzyMatch(c.label + " " + c.description + " " + c.category, query)
      )
    : COMMANDS;
    ...
    >
      ...
      >
                  ...
                  return (
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <p
                          className={`text-sm font-medium truncate ${isActive ? "text-indigo-600 dark:text-indigo-400" : "text-gray-800 dark:text-gray-100"}`}
                        >
                      ...
                      {isActive && (
                        <kbd className="text-xs bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300 px-1.5 py-0.5 rounded">
                          ↵
                        </kbd>
                      )}
                    </button>
        ...
        <div className="flex items-center gap-4 px-4 py-2 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-400">
          ...
          <span>
            <kbd className="bg-gray-100 dark:bg-gray-700 px-1 rounded">Esc</kbd>{" "}
            close
          </span>
        </div>
      </div>
