            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-3xl">
                <div className="inline-flex items-center gap-2 rounded-full border border-violet-300/20 bg-violet-500/10 px-4 py-2 text-sm text-violet-700 dark:text-violet-100 shadow-sm shadow-violet-500/10">
                  <HeartPulse className="h-4 w-4 text-violet-600 dark:text-violet-200" /> Wellness & Mental Health
                </div>
              ...
              <div className="rounded-3xl border border-slate-200/80 dark:border-white/10 bg-slate-50/90 dark:bg-slate-950/80 p-6 shadow-xl shadow-slate-200/30 dark:shadow-slate-950/30 sm:p-6">
                <p className="text-sm uppercase tracking-[0.45em] text-slate-600 dark:text-slate-400">Journal Goals</p>
                <p className="mt-4 text-3xl font-semibold text-slate-900 dark:text-white">Daily writing focus</p>
                <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-400">Set a gentle reflection intention and keep your journal habit connected to wellbeing.</p>
                <div className="mt-5 space-y-3">
                  <div className="rounded-3xl bg-slate-100/80 dark:bg-white/5 p-4 text-left text-sm text-slate-900 dark:text-slate-100 ring-1 ring-slate-200/50 dark:ring-white/10">
                    <p className="font-semibold text-slate-900 dark:text-white">1. Capture one win</p>
                    <p className="mt-1 text-slate-600 dark:text-slate-400">Record a positive moment from today.</p>
                  </div>
                  <div className="rounded-3xl bg-slate-100/80 dark:bg-white/5 p-4 text-left text-sm text-slate-900 dark:text-slate-100 ring-1 ring-slate-200/50 dark:ring-white/10">
                    <p className="font-semibold text-slate-900 dark:text-white">2. Note a proud progress</p>
                    <p className="mt-1 text-slate-600 dark:text-slate-400">Celebrate your effort, however small.</p>
                  </div>
                  <div className="rounded-3xl bg-slate-100/80 dark:bg-white/5 p-4 text-left text-sm text-slate-900 dark:text-slate-100 ring-1 ring-slate-200/50 dark:ring-white/10">
                    <p className="font-semibold text-slate-900 dark:text-white">3. Keep the habit</p>
                    <p className="mt-1 text-slate-600 dark:text-slate-400">Return tomorrow with a fresh note.</p>
                  </div>
                </div>
              </div>
            </div>
