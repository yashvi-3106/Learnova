          ...
          <section className="pt-12 text-center max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="mx-auto max-w-3xl text-lg leading-8 text-slate-600 dark:text-slate-300">
                ...
                These values guide every product decision and community interaction.
              </p>
            ...
            <div className="text-center space-y-4">
                ...
                These principles define the culture, vision, and direction of Learnova.
                </p>
            </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            {value.title === "Student First" && (
                                ...
                                by designing tools that simplify learning, improve engagement,
                                and create meaningful educational journeys.
                                </>
                            )}
                            ...
                            {value.title === "Accessibility" && (
                                ...
                                is fundamental to education, ensuring every learner can access
                                resources and opportunities without barriers.
                                </>
                            )}
                            ...
                            {value.title === "Open Collaboration" && (
                                ...
                                where contributors, educators, and students work together to
                                create innovative learning solutions.
                                </>
                            )}
                            ...
                            {value.title === "Transparency" && (
                                ...
                                through honest communication, ethical development, and clear
                            ...
                            {value.title === "Innovation" && (
                                ...
                                to redefine educational experiences using modern and intelligent
                                technologies.
                                </>
                            )}
                            ...
                            {value.title === "Continuous Learning" && (
                                ...
                                by encouraging curiosity, mentorship, skill development, and
                                lifelong educational growth.
                                </>
                            )}
        ...
        <div className="relative z-10 flex items-start gap-5">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm leading-7 text-slate-500 dark:text-slate-400">
              ...
              collaborative, and innovation-driven educational ecosystem
              for students, educators, and contributors.
            </p>
          </div>
        </div>
      </div>
          ...
          <section className="relative overflow-hidden rounded-[2.5rem] border border-slate-200/80 dark:border-white/10 bg-white/80 dark:bg-white/5 px-8 py-20 text-center backdrop-blur-xl">
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-8">
              ...
              <p className="text-lg leading-8 text-slate-600 dark:text-slate-300">
                ...
                ecosystem built on collaboration, innovation, accessibility,
